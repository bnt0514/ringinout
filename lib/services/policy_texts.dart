...
String _getSubscriptionPolicyEn({required bool isBeta}) {
  ...
  b.writeln('- Free: 2 places, 2 active alarms');
  b.writeln('- Basic: 5 places, 10 active alarms (ad-free)');
  b.writeln('- Premium: Unlimited places/alarms (ad-free)');
  b.writeln();
  b.writeln('3. Payment & Auto-Renewal');
  ...
  b.writeln();
  b.writeln('4. Cancellation & Plan Changes');
  ...
  if (isBeta) {
    ...
    b.writeln('7. Limitation of Liability');
  }
  b.writeln(
...
String _getSubscriptionPolicyJa({required bool isBeta}) {
  ...
  b.writeln('- Free: 場所2個、アクティブアラーム2個');
  b.writeln('- Basic: 場所5個、アクティブアラーム10個（広告なし）');
...
String _getSubscriptionPolicyZh({required bool isBeta}) {
  ...
  b.writeln();
  b.writeln('2. 方案与范围');
  b.writeln('- Free: 2个地点，2个活动闹钟');
  b.writeln('- Basic: 5个地点，10个活动闹钟（无广告）');
